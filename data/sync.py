...
def filter_kenyaopendata():
  ...
  filter_data('kenya-primary-schools.csv','kibera-primary-schools.csv','Division','Geolocation','Name of School', other_columns)
  ...
  filter_data('kenya-secondary-schools.csv','kibera-secondary-schools.csv','Division','Location 1','Name of School', other_columns) #Code??
